/* global React, ReactDOM, Sidebar, Topbar, useStudyState,
   ...
   ScreenProjects, ScreenDomain, ScreenReference, ScreenExamDay,
  ...
  return (
    <>
      ...
      <TweaksPanel>
        ...
        <TweakButton onClick={() => study.seedDemo()}>Seed demo progress</TweakButton>
        <TweakButton onClick={() => study.reset()}>Reset all progress</TweakButton>
      </TweaksPanel>
    </>
  );
}
